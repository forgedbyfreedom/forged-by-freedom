    ...
    namespace $w {
        ...
        namespace Box {
            ...
            type Accessibility = {
                ...
                ariaBusy?: boolean;
                /**
                 * Identifies the element that is controlled by visitor interactions with this element. This property helps assistive technologies convey which elements are affected by the controlling element. For example, a button element that opens a popup window when clicked controls the lightbox element.
                 */

...
TOPICS = [
    ...
    "sports dietitian athlete nutrition",
    "carbohydrate periodization athletes",
    "ketogenic diet athletic performance",
    "intermittent fasting muscle mass",
    "micronutrient deficiency athletes",
    "iron deficiency athletes performance",
    ...
    "protein distribution muscle synthesis",
    "leucine threshold muscle protein",

    # ENDOCRINOLOGY (expanded)
    "hypothalamic pituitary axis exercise",
    "thyroid function athletes",
    "adrenal fatigue overtraining",
    "insulin sensitivity exercise training",
    "glucagon exercise metabolism",
    "estrogen exercise women",
    "progesterone athletic performance",
    "menstrual cycle athletic performance",
    "menopause exercise intervention",
    "testosterone women exercise",
    "DHEA supplementation performance",
    "melatonin sleep athletes",
    "prolactin exercise stress",

    # SPORTS PSYCHOLOGY (expanded)
    "mental toughness athletes",
    "sports performance anxiety",
    "visualization athletic performance",
    "self efficacy sports performance",
    "motivation exercise adherence",
    "burnout athletes prevention",
    "mindfulness sports performance",
    "flow state athletic performance",
    "goal setting sports psychology",
    "confidence athletic performance",
    "stress management athletes",
    "cognitive behavioral therapy athletes",
    ...
    "ballistic training performance",
    "complex training post activation",
    "cluster sets resistance training",
    "blood flow restriction training",
    "concurrent training interference",
    "detraining muscle loss",
    "tapering athletic performance",
    "altitude training performance",
    "heat acclimation exercise",
    "cooling strategies performance",

    # FEMALE ATHLETES (expanded)
    "relative energy deficiency sport",
    "female athlete triad",
    "ACL injury prevention female",
    "pregnancy exercise guidelines",
    "postpartum return exercise",
    "oral contraceptives athletic performance",
    "amenorrhea athletes treatment",
    "bone health female athletes",
]

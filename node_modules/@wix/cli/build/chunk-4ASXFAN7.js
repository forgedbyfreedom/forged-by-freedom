...
function getExtensionPath(projectFolder, extensionPath) {
  return join(projectFolder, "src", "extensions", extensionPath);
}
...
async function readWixConfig(projectFolder) {
  ...
  if (config.success) {
    if (config.data.projectType === "App") {
      throw new CliError({
        code: CliErrorCode.AppProjectTypeNotImplemented(),
        cause: null
      });
    }
    return config.data;
...
//# sourceMappingURL=chunk-4ASXFAN7.js.map
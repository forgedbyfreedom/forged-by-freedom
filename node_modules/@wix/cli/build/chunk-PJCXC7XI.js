...
async function updateEnvFile(target, variables) {
  const mergedEnvVars = {
    ...await readEnvFile(target),
    ...variables
  };
  const outputEnvVar = Object.entries(mergedEnvVars).map(([key, value]) => `${key}="${value}"`).join("\n");
...
//# sourceMappingURL=chunk-PJCXC7XI.js.map